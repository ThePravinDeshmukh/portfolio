        ...
        <section className="colorlib-blog" data-section="blog">
			<div className="colorlib-narrow-content">
				<div className="row">
					...
					<h2 className="colorlib-heading">Recent </h2>
					</div>
				</div>
				<div className="row">
					...
					<div className="blog-entry">
						...
						<div className="desc">
							<span><small> </small> | <small>  </small> | <small> <i className="icon-bubble3" /> 4</small></span>
				...
				<div className="row">
					...
					<p><a href="#" className="btn btn-primary btn-lg btn-load-more"><i className="icon-reload" /></a></p>
					</div>
				</div>
			</div>
			</section>
